...
# Concept PM Communicator project
#\**********************************************************/
...
set (LIBRARY_PATH ${FireBreath_SOURCE_DIR}/../ConceptPMCommunicator/Win/libs)

target_link_libraries(${PROJECT_NAME} "${LIBRARY_PATH}/PM3USBCP.lib")
target_link_libraries(${PROJECT_NAME} "${LIBRARY_PATH}/PM3CsafeCP.lib")
target_link_libraries(${PROJECT_NAME} "${LIBRARY_PATH}/PM3DDICP.lib")
...
add_wix_installer( ${PLUGIN_NAME}
    ${CMAKE_CURRENT_SOURCE_DIR}/Win/WiX/ConceptPMCommunicatorInstaller.wxs
    PluginDLLGroup
